...
CDialogCalc::CDialogCalc(CWnd* pParent /*=NULL*/): CDialogEx(IDD_DIALOG_CALC, pParent)
{
}
...
BOOL CDialogCalc::OnInitDialog()
{
	CDialogEx::OnInitDialog();
	{
		...
		for (auto ptr : m_vDlgPtr) {
			ptr->MoveWindow(rcTree.Width() + 40, rcTree.top, rc.Width() - rcTree.Width()+300, rcTree.Height());
