// Ex0003  股票仿真系统 Wangxiaoyao Add  工具页签-截屏功能 2021.8.15

#include "pch.h"
#include "Resource.h"

#include "CDialogScreenShot.h"
#include "CScreenTools.h"

IMPLEMENT_DYNAMIC(CDialogScreenShot, CDialogEx)

CDialogScreenShot::CDialogScreenShot(CWnd* pParent /*=NULL*/) : CDialogEx(IDD_DIALOG_SCREEN_SHOT, pParent)
{
}
